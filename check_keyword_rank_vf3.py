...
def main():
    driver = setup_driver()
    keywords = [
        "Màn hình android cho xe vf3", "Màn hình tốt nhất cho xe vf3", "Màn hình cho xe vf3",
        "màn hình android VF3", "Camera lùi VF3",
        "chọn màn hình xe VF3", "tiêu chí màn hình android VF3",
